...
import Loadin from '../../components/Loader/Loadin'
...

        {
          ...
          <div className='md:col-span-2 md:px-[30px]'>
              ...
              <button
                ...
                className={` ${tab==='settings' && 'bg-primaryColor text-white font-normal'} py-2 px-5 rounded-md text-headingColor font-semibold
