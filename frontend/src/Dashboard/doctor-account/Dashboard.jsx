...
import Loader from '../../components/Loader/Loadin'
              ...
              <div className='mt-8'>
                {tab==='overview' &&  (
                  <div>
                    ...
                    <DoctorAbout className={data.name} about={data.about} qualifications={data.qualifications} experiences={data.experiences} />
                  </div>)}
