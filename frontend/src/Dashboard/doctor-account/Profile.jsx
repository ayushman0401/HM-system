...
const Profile = ({doctorData}) => {
    ...
    const hadleReuseableInputChangeFunc=(key,index,event)=>{
    ...
    const handleQualificationChange=(event,index)=>{
        hadleReuseableInputChangeFunc('qualifications',index,event);
    }
    ...
    const handleExperienceChange=(event,index)=>{
        hadleReuseableInputChangeFunc('experiences',index,event);
    }
    ...
    const handleTimeSlotChange=(event,index)=>{
        hadleReuseableInputChangeFunc('timeSlots',index,event);
    }
        ...
        <div className='mb-5'>
            <div className='grid grid-cols-3 gap-5 mb-[30px]'>
                ...
                <div>
                    ...
                    <input type='number' placeholder='100' name='ticketPrice' onChange={handleInputChange} value={formData.ticketPrice} className='form_input'/>
                </div>
                        ...
                        <div className='grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5 '>
                            <div>
                                <p className='form_label'>Day*</p>
                                 <select name='day' onChange={e=>handleTimeSlotChange(e,index)}  value={item.day} className='form_input py-3.5' >   
                                    <option value=''>Select</option>
            ...
            {formData.photo && (<figure className='w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center'>
              ...
              <div className='relative w-[160px] h-[50px]'>
                <input 
                  ...
                  />
                  <label htmlFor='customFile' className='absolute top-0 left-1 w-full h-full flex justify-center items-center px-[0.75rem] py-[0.375rem]
                  text-[16px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer '>
                    Upload Photo
                  </label>
              </div>
        </div>
